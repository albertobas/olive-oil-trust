...
} from 'subgraph/src/generated/types/DistributorUpgradeableDataSource/DistributorUpgradeable';
...
export function handleNameSet(event: NameSet): void {
  registerMemberName(event.address, event.params.name, 'Distributor');
}
